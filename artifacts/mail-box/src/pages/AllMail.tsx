        ...
        <div className="flex-1 overflow-y-auto bg-gray-100 dark:bg-slate-950">
          <div className="max-w-4xl mx-auto px-4 py-5 space-y-4">
            ...
            <div style={{ background: "#f0f5ff" }} className="dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-2xl shadow-sm overflow-hidden">
              ...
              <div className="flex items-center justify-between px-4 py-3 select-none">
                <div className="flex items-center gap-2 cursor-pointer flex-1" onClick={() => setNoteOpen((v) => !v)}>
                  ...
                  {total > 0 && (
                    <span className="text-[11px] bg-amber-100 dark:bg-amber-900/50 text-amber-700 dark:text-amber-300 font-semibold px-2.5 py-0.5 rounded-full">
                      {total} mails
                    </span>
                  )}
                  {dupWarning > 0 && (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-4 py-1.5 text-xs font-bold rounded-lg transition-all ${
                      hasUnsaved
                        ...
                        : "bg-emerald-500 hover:bg-emerald-600 text-white shadow-sm opacity-70"
                    }`}
                  >
                  ...
                  {/* Clear Note button — amber/yellow style like the image */}
                  {confirmClear ? (
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-4 py-1.5 text-xs font-semibold bg-amber-50 dark:bg-amber-900/30 border border-amber-300 dark:border-amber-700 text-amber-700 dark:text-amber-400 rounded-lg hover:bg-amber-100 dark:hover:bg-amber-900/50 transition-colors"
                    >
            ...
            {total > 0 && (() => {
              ...
              return (
                <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm px-4 py-2">
                  ...
                  <div className="grid grid-cols-4 gap-2 mb-2">
                    <div className="flex items-center justify-center gap-1.5 bg-slate-50 dark:bg-slate-700/50 rounded-xl py-1 px-2">
                    ...
                    <div className="flex items-center justify-center gap-1.5 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl py-1 px-2">
                    ...
                    <div className="flex items-center justify-center gap-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-xl py-1 px-2">
                      <span className="text-sm font-extrabold text-blue-600 dark:text-blue-400 leading-none">{remaining}</span>
                      <span className="text-[10px] text-blue-400 dark:text-blue-500 font-medium">Left</span>
                    </div>
                    <div className={`flex items-center justify-center gap-1.5 rounded-xl py-1 px-2 ${overdueCount > 0 ? "bg-red-50 dark:bg-red-900/20" : "bg-orange-50 dark:bg-orange-900/10"}`}>
                      ...
                      <span className={`text-[10px] font-medium ${overdueCount > 0 ? "text-red-400 dark:text-red-500" : "text-orange-400 dark:text-orange-500"}`}>{overdueCount > 0 ? "Overdue" : "Sched."}</span>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
